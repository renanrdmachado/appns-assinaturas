...
/**
 * Classe de serviço para operações com Assinaturas relacionadas a um Seller no contexto Nuvemshop
 */
class NsSubscriptionsService {
    /**
...
module.exports = new NsSubscriptionsService();