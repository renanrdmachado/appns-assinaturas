    ...
    async create(data) {
        ...
        try {
            ...
            const result = await sequelize.transaction(async (t) => {
                // Sempre criar um UserData, mesmo que vazio
                const payloadUD = data.userData || {};
                const userData = await UserData.create({
                    cpfCnpj: payloadUD.cpfCnpj || null,
                    mobilePhone: payloadUD.mobilePhone || null,
                    address: payloadUD.address || null,
                    addressNumber: payloadUD.addressNumber || null,
                    province: payloadUD.province || null,
                    postalCode: payloadUD.postalCode || null,
                    birthDate: payloadUD.birthDate || null
                }, { transaction: t });
